<?php
//start session when admin logs in is successful
session_start();
...
include 'connection.php';
	 $quer="Select *from admin where admin_id='$user' and admin_password='$pass'";
	 ...
	 header("Location:admin_home_page.php");
	 	 ...
	 	 echo '<p style="color:red;text-align:center;"><b>Username or password is wrong.</b></p>';
