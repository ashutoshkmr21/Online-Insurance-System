...
<head>
<style>
//css or layout design for the page
#cssmenu li,
#cssmenu a {
  list-style: none;
  margin: 0;
...
<body>
<!--Display the welcome user and logout bar -->
<div id='cssmenu'>
<ul>
	 
	 <li style="float:right"><a href="logout.php"><span>Log Out</span></a></li>
	 <li style="float:right;margin-right:80%; margin-top:8px;"disabled="true"><span style="color:white;text-decoration:none;">Welcome <?php $y=$_SESSION['username']; echo "$y" ?></span></li>
</ul>
</div>
